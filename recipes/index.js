...
let button = document.querySelector('.search-recipe');
...
function recipesTemplate(recipe) {
    return `<div class="recipe">
                <img src="${recipe.image}" alt="image of apple crisp">

                <div class="recipe-information">
                    <p class="category">${tagTemplate(recipe.tags)}</p>

                    <h2 class="recipe-name">${recipe.name}</h4>
